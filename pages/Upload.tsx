import { CreditCardIcon, KeyIcon, UploadIcon,  UserGroupIcon, ViewGridAddIcon } from '@heroicons/react/outline'
import Head from './Head'

const navigation = [
  { name: 'Upload Post', href: '#', icon: UploadIcon, current: true },
...
export default function Upload() {
  return (
    <div className=''>
    <Head />
    <div className="lg:grid lg:grid-cols-12 lg:mt-10  lg:gap-x-5">
